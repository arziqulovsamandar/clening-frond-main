<template>
  <button
    :class="classess"
    :disabled="isLoading"
    class="flex justify-center items-center px-5 py-2 rounded-s-full rounded-e-full border-none disabled:cursor-not-allowed text-white text-[18px]"
  >
    <slot></slot>
    <div v-if="isLoading">
      <svg
...
const type_style = {
  primary:
    "bg-bg_color hover:bg-[#5388a8] active:bg-[#416D89] disabled:bg-[#416D89]",

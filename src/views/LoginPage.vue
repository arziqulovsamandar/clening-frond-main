<template>
  <div
    class="bg-big_color flex justify-center items-center w-full h-screen px-20 max-md:px-5"
  >
    <div
      class="self-center flex w-[456px] max-w-full flex-col mt-16 mb-24 max-md:my-10"
    >
      <div
      ...
      <form @submit.prevent="login">
        ...
        >
          <div
            class="text-bg_color text-base leading-6 whitespace-nowrap self-start"
          >
            Username
          </div>
          <div
          ...
          <div
            class="flex w-[376px] max-w-full items-start justify-between gap-5 mt-4 self-start"
          >
            <div class="text-bg_color text-base leading-6 self-start">
              Password
            </div>
          </div>
          <div
